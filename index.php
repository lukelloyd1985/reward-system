<html>
  ...
  <body>
    ...
    <table>
      ...
      <tr>
        <td><div style="padding:10px 16px"><div style="background-color:lightblue; border-radius:8px"><div style="padding:10px 16px; background-color:lightblue; border-radius:8px; width:70%">&nbsp;<img src="https://cdn-icons-png.flaticon.com/512/5537/5537993.png" style="width:20px;float:right"></div></div></div></td>
        <td><div style="padding:10px 16px"><div style="background-color:lightblue; border-radius:8px"><div style="padding:10px 16px; background-color:lightblue; border-radius:8px; width:70%">&nbsp;<img src="https://cdn-icons-png.flaticon.com/512/5537/5537993.png" style="width:20px;float:right"></div></div></div></td>
      </tr>
      <tr>
